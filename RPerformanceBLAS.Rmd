...
The precompiled R distribution that is downloaded from CRAN makes use of the reference BLAS/LAPACK implementation for linear algebra operations, These implementations are built to be stabled and cross platform compatible but are not optimized for performance. 
...
The above mentioned libraries are highly optimized for the Intel
